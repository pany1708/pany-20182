...
import com.kingthy.util.FreeMarkerUtils;
...
//        tbSnMapper.updateLastValue(sn);
    ...
    private HiloOptimizer dyeingPatternHiloOptimizer = null;
    ...
    @Value("${sn.dyeingPattern.prefix}")
    private String snDyeingPatternPrefix;// = environment.getProperty("sn.accessories.prefix");

    @Value("${sn.dyeingPattern.maxLo}")
    private int snDyeingPatternMaxLo;// = Integer.valueOf(environment.getProperty("sn.accessories.maxLo"));;
        ...
        throws Exception
    {
        ...
        dyeingPatternHiloOptimizer = new HiloOptimizer(Sn.Type.dyeingPattern, snDyeingPatternPrefix, snDyeingPatternMaxLo);
    }
    ...
    public String generate(Sn.Type type)
    {
        ...
        if (type == Sn.Type.dyeingPattern)
        {
            return this.dyeingPatternHiloOptimizer.generate(type);
        }
        return null;
    }
