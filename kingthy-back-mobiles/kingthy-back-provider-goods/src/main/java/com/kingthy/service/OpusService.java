...
public interface OpusService
{
    ...
    WebApiResponse updateOpus(@PathVariable(name = "uuid") String uuid, @PathVariable(name = "status") Integer status,@RequestHeader("Authorization") String token);
    ...
    class HystrixClientFallback implements OpusService
    {
        ...
        @Override
        public WebApiResponse<?> updateOpus(String uuid, Integer status, String token)
        {
