...
public class AreaServiceImpl implements AreaService
{
    ...
    public List<Area> getProvince()
    {
        ...
        String cacheKey= CacheKeysConstants.generateCacheKey(Area.class,"Province");
        ...
        else
        {
            ...
            if (expire <= 0)
            {
                redisManager.set(cacheKey, JSON.toJSONString(areaList), TimeUnit.DAYS);
            }
        }
        return areaList;
    }
    ...
    {
        String cacheKey= CacheKeysConstants.generateCacheKey(Area.class,parentId+""+grade);
