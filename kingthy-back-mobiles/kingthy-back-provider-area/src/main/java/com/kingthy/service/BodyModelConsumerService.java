...
/**
 * BodyModelService(描述其作用)
 * <p>
 * @author 赵生辉 2017年07月03日 17:52
 *
 * @version 1.0.0
 */
...
public interface BodyModelConsumerService
{
    ...
    WebApiResponse<?> getBodyModelByUuid(@PathVariable(name = "parms") String token,
    ...
    WebApiResponse<?> getBodyModelList(@PathVariable(name = "token") String token);
    ...
    WebApiResponse<?> getDefaultBodyModel(@PathVariable(name = "token") String token);
    ...
    WebApiResponse<?> updateModel(@RequestBody UpdateModelReq updateModelReq);
    ...
    WebApiResponse<?> createrModel(@RequestBody CreaterModelReq createrModelReq);
    ...
    WebApiResponse<?> deleteModel(@PathVariable(name = "uuid") String uuid);
