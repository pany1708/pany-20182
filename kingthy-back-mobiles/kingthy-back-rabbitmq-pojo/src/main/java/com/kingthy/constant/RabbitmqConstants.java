 ...
 */
    ...
    /*********本地缓存start****/
    private static final String  LOCAL_CACHE_KEY = "local.cache.update";
    /**队列****/
    public static final  String  LOCAL_CACHE_QUEUE=LOCAL_CACHE_KEY+QUEUE_SUFFIX;
    /**交换器****/
    public static final  String  LOCAL_CACHE_EXCHANGE=LOCAL_CACHE_KEY+TOPIC_SUFFIX;
    /**路由key****/
    public static final  String  LOCAL_CACHE_ROUTING=LOCAL_CACHE_KEY+ROUTING_SUFFIX;
    /*********本地缓存end****/
