...
import com.kingthy.dto.AccessorieDto;
...
public class OpusController
{
    ...
    @PostMapping("/create")
    public WebApiResponse<?> addOpus(@RequestBody CreateOpusReq createOpusReq,
...
//        }
        ...
        try
        {
            JSONArray.parseArray(opus.getOpusMaterialInfo(),MaterieDto.class);
        }
        catch (Exception e)
        {
            return WebApiResponse.error("面料参数不正确");
        }
        try
        {
            JSONArray.parseArray(opus.getOpusAccessoriesInfo(),AccessorieDto.class);
        }
        catch (Exception e)
        {
            return WebApiResponse.error("辅料参数不正确");
        }
        try
        {
            JSONArray.parseArray(opus.getOpusPartsInfo(), PartInfoDto.class);
        }
        catch (Exception e)
        {
            return WebApiResponse.error("部件参数不正确");
        }
    ...
    public WebApiResponse<?> queryOpusList(@RequestBody QueryOpusListReq queryOpusListReq,
        @RequestHeader("Authorization") String token){
