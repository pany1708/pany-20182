...
public class OrderProviderController
{
    ...
    public WebApiResponse<?> showSingleOrderInfo(@PathVariable @ApiParam(value = "订单号") String orderSn, @RequestHeader("Authorization") String token)
    {
        ...
        try {
            ...
            result = orderService.showSingleOrderInfo(orderSn, token);
